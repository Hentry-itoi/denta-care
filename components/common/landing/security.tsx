...
export function Security() {
  ...
  return (
    <section
      id="security"
      className="relative py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-background via-muted/30 to-background overflow-hidden border-t border-border/80"
    >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {securityFeatures.map((item, idx) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl ${item.color} flex items-center justify-center group-hover:scale-110 transition-transform shadow-sm`}
                >
