          ...
          <div className="flex justify-center pt-4">
            <div className="inline-flex items-center p-1.5 rounded-2xl bg-muted/70 border border-border/60 shadow-inner">
              <button
                ...
                className={`px-6 py-2.5 rounded-xl text-sm font-bold transition-all duration-300 ease-out cursor-pointer ${
              ...
              <button
                ...
                className={`flex items-center gap-2 px-6 py-2.5 cursor-pointer rounded-xl text-sm font-bold transition-all duration-300 ease-out ${
                  billingCycle === "yearly"
                    ? "bg-background text-foreground shadow-md scale-105"
                    : "text-muted-foreground hover:text-foreground hover:bg-muted/50 hover:scale-105 active:scale-95"
                }`}
            ...
            >
              ...
              {plan.badge && (
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
                  <span
                    className={`whitespace-nowrap px-4 py-1.5 rounded-full text-xs font-extrabold shadow-md tracking-wider uppercase ${
                      plan.popular
