...
export function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Yes. We provide video tutorials, documentation, webinars, and personalized training sessions for your team at no extra cost.",
    },
  ];
        ...
        <div className="space-y-4">
          {faqs.map((faq, idx) => (
            ...
            >
              ...
              >
                <h3 className="font-bold text-lg text-left text-foreground">
                  {faq.question}
                </h3>
                <ChevronDown
                  size={24}
