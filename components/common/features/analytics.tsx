              ...
              {[
                {
                  ...
                  desc: "Real-time revenue tracking with daily, weekly, and monthly trend comparisons.",
                },
                {
                  icon: PieChart,
                  title: "Treatment Analytics",
                  desc: "See which procedures generate the most revenue and which need promotion.",
                },
                {
                  icon: Activity,
                  title: "Patient Metrics",
                  desc: "Track new patient acquisition, retention rates, and patient lifetime value.",
                },
                {
                  icon: LineChart,
                ...
                },
                {
                  ...
                  desc: "Compare revenue vs expenses with real-time profit margin calculations.",
                },
                {
                  icon: FileDown,
                  title: "Export Reports",
                  desc: "Download comprehensive Excel and PDF reports for accounting and review meetings.",
                },
              ].map((cap, i) => (
                <div
                  key={i}
