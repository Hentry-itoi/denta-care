  ...
  return (
    <div className="bg-background text-foreground">
        ...
        <section className="relative py-28 px-4 sm:px-6 lg:px-8 overflow-hidden border-b border-border/80">
          ...
          <div
            className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-br from-cyan-500/15 to-primary/15 rounded-full blur-3xl animate-morph-blob opacity-20"
          ...
          <div className="max-w-7xl mx-auto space-y-12">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight">
                Billing That Works While You Treat
              </h2>
            </div>
            <div
              ...
              {[
                {
                  ...
                  desc: "Auto-generate detailed invoices with procedure codes, descriptions, and pricing.",
                },
                {
                  icon: Wallet,
                  title: "Multi-Payment Methods",
                  desc: "Accept cash, cards, UPI, net banking, and insurance payouts seamlessly.",
                },
                {
                  icon: Send,
                  title: "Auto Payment Reminders",
                  desc: "Overdue invoices trigger automated SMS and email reminders to patients.",
                },
                {
                  icon: Receipt,
                  title: "PDF & Print",
                  desc: "Download branded PDF invoices or print receipts directly from the dashboard.",
                },
                {
                  icon: Percent,
                  title: "Tax & Discounts",
                  desc: "Built-in GST/VAT calculation and flexible discount rules per procedure.",
                },
                {
                  icon: DollarSign,
                  title: "Payment Links",
                  desc: "Send one-click payment links via WhatsApp or email for instant patient checkout.",
                },
              ].map((cap, i) => (
                <div
                  key={i}
