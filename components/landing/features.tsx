  ...
  const features = [
    {
      ...
      description: 'Intuitive appointment scheduling with automated SMS reminders and conflict detection.',
      color: 'from-blue-500/20 to-blue-600/20',
    },
    {
      icon: Users,
      title: 'Patient Management',
      description: 'Comprehensive patient profiles with complete medical history and treatment plans.',
      color: 'from-cyan-500/20 to-cyan-600/20',
    },
    {
      icon: CreditCard,
      title: 'Payment Processing',
      description: 'Secure payments with multiple methods and automated invoice generation.',
      color: 'from-emerald-500/20 to-emerald-600/20',
    },
    {
      icon: BarChart3,
      title: 'Real-time Analytics',
      description: 'Comprehensive dashboards with key metrics and financial insights at a glance.',
      color: 'from-purple-500/20 to-purple-600/20',
    },
    {
      icon: Bell,
      title: 'Smart Notifications',
      description: 'Real-time alerts for appointments, payments, and important clinic activities.',
      color: 'from-orange-500/20 to-orange-600/20',
    },
    {
      icon: Lock,
      title: 'Enterprise Security',
      description: 'HIPAA compliant with end-to-end encryption and automated daily backups.',
    ...
    },
    {
      ...
      description: 'Tailor workflows to match your clinic operations with flexible configurations.',
      color: 'from-teal-500/20 to-teal-600/20',
    },
  ]

  return (
    <section id="features" className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden bg-background">
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 space-y-4">
                  <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${feature.color} flex items-center justify-center border border-border/50 group-hover:scale-110 transition-transform shadow-md`}>
                    <Icon className={`text-primary w-6 h-6`} />
                  </div>
                  
                  <div className="space-y-2">
                    <h3 className="font-bold text-lg text-foreground">{feature.title}</h3>
                    <p className="text-xs text-foreground/75 leading-relaxed">{feature.description}</p>
                  </div>
