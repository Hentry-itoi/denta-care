...
const systemModules: SystemModule[] = [
  {
    ...
    badge: "Core Hub",
    description:
      "Get an instant 360° overview of your practice with real-time revenue stats, pending invoices, and daily patient queues.",
    keyFeatures: [
  ...
  },
  {
    ...
    badge: "Scheduling",
    description:
      "Manage doctor schedules effortlessly. Track appointment statuses and eliminate double-booking with conflict detection.",
    keyFeatures: [
      "Daily & weekly views",
  ...
  },
  {
    ...
    badge: "Payments",
    description:
      "Accept cash, cards, online transfers, and insurance payouts. Track partial payments and overdue balances instantly.",
    keyFeatures: [
  ...
  },
  {
    ...
    badge: "Billing",
    description:
      "Generate itemized invoices for treatments. Send PDF receipts directly to patients via email or WhatsApp.",
    keyFeatures: [
      "Itemized procedure billing",
  ...
  },
  {
    ...
    badge: "Accounting",
    description:
      "Log operational costs such as lab fees, equipment maintenance, staff salaries, and supply inventory purchases.",
    keyFeatures: [
      "Expense tagging",
      "Receipt uploads",
  ...
  },
  {
    ...
    badge: "Analytics",
    description:
      "Make data-driven decisions with detailed reports on monthly profits, treatment success rates, and staff performance.",
    keyFeatures: [
...
export function ImageGallery() {
  const [selectedCategory, setSelectedCategory] = useState<
    "All" | "Operations" | "Financials" | "Administration"
  >("All");
  ...
  return (
    <section
      id="gallery"
      className="relative py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-muted/30 via-background to-muted/20 overflow-hidden border-t border-border/80"
    >
      ...
      <div className="max-w-7xl mx-auto space-y-12 relative z-10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2">
          {(["All", "Operations", "Financials", "Administration"] as const).map(
            (cat) => (
              <button
                key={cat}
          ...
          <div className="relative max-w-5xl w-full bg-card border border-border rounded-2xl overflow-hidden shadow-2xl space-y-4 p-4 sm:p-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
              ...
              <div onClick={() => setPreviewImage(null)}>
                ...
                >
                  Get Started with {previewImage.badge}{" "}
